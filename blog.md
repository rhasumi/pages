...
## 2025年12月13日 [JuliaLang Japan 2025](https://julialangja.github.io/julialangja2025/)

Zoomで視聴させていただき、思いの外勉強になりました。
そうなんですよ、やっぱりLU分解がボトルネックになっていて（sperseでもdenseになり、並列化も容易ではない）、計算が早くなって欲しいです。

なお、Juliaは難しいので（色んな意味でプロ向けなので）、RやPythonやMatlabで不満がある人以外には勧められません。
Juliaで数学の演習を教えたという城北高校の校長先生の報告がありましたが、私は1年性の学生向けにはRを教えています。

東大の工学系の先生の
```
線形代数は重要
大学1年性から習うが、うまみがわかるのは卒論以降
```
もすごく共感しました。我々が線形代数をやるのは大学院か社会人になってからですが…

## 2025年12月9日 Juliaの件

並列計算しているJuliaがMac OSにkillされて物騒だったのですが、
どうもメモリリークが原因らしく、ループの途中で
```
GC.gc()
```
を挟むとスワップ使用領域が一気に解放されて、エラーも解消しました。

（追記）この件、自分のプログラムで意図しないことをしていて、それを修正したらGCを自動にしてもメモリリークが解消しました。

## 2025年12月1日

令和7年試験限りをもって、公認会計士試験試験委員（経済学）を退任しました。

経済学は「受験者数が少ない選択科⽬」ですが、予備校の先生がコメントしてくれるので、それは見ていました。というか、旧試験時代に受験したのですが、そのとき教わった先生です。

なお、「受験者数が少ない選択科⽬」については今後「適正な能⼒判定が⾏えるよう得点換算⽅法等について検討」するとのことです。

[公認会計士試験のバランス調整について（令和7年6月）](https://www.fsa.go.jp/cpaaob/kouninkaikeishi-shiken/20250612.html)
